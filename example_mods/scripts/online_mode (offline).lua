...
function onCreate()
    ...
    makeLuaText('opponentTextChat', 'entrou no server aj engine ofc', 0, getProperty('opponentName.width')+ 5, 640)
	setTextSize('opponentTextChat', 30)
    ...
    makeLuaText('playerTextChat', 'entrou no server aj engine ofc', 0, getProperty('playerName.width')+ 5, 680)
	setTextSize('playerTextChat', 30)
...
function onEvent(name, value1, value2)
  if name == 'Change Character' then
   ...
   if value1 == 'Dad' or value1 == '1' then
  	 opponentChatTextIsNeedToBeShow = true 
     setTextString('opponentTextChat', 'entrou no server aj engine ofc') 	 
   end      
    setTextString('playerName', ''..boyfriendName..':')	
	setProperty('playerTextChat.x', getProperty('playerName.width')+ 5)	
   if value1 == 'BF' then
	 playerChatTextIsNeedToBeShow = true  
     setTextString('playerTextChat', 'entrou no server aj engine ofc') 		 
   end  	
  end
end
